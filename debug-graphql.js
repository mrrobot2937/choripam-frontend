...
async function debugGraphQL() {
    ...
    // Test 1: Verificar con restaurant_id = "choripam"
    console.log('1. Testeando con restaurantId: "choripam"');
    try {
    ...
    // Test 2: Verificar con restaurant_id = "rest_choripam"
    console.log('2. Testeando con restaurantId: "rest_choripam"');
    try {
        const result2 = await client.query({
            query: GET_ORDERS,
            variables: {
                restaurantId: 'rest_choripam',
                status: undefined,
                limit: undefined
            },
            fetchPolicy: 'network-only'
    ...
    console.log('3. Testeando productos con restaurantId: "choripam"');
